      ...
      <section id="formulario" className="py-16 bg-white">
        <div className="container-custom">
          <div className="grid md:grid-cols-2 gap-12">
            {/* Contact Info */}
            <div>
              <h2 className="text-2xl md:text-3xl font-bold mb-6 text-text">Informações de Contato</h2>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-dark mt-1">bvcaldeiraria@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-text">Telefone</h3>
                    <p className="text-gray-dark mt-1">(16) 99162-4446</p>
                    <p className="text-gray-dark">(WhatsApp disponível)</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-text">Redes Sociais</h3>
                    <div className="flex space-x-4 mt-2">
                      <a href="https://instagram.com/bvcaldeiraria" target="_blank" rel="noopener noreferrer" className="text-gray-dark hover:text-primary transition-colors">
                      ...
                      <a href="https://facebook.com/bvcaldeiraria" target="_blank" rel="noopener noreferrer" className="text-gray-dark hover:text-primary transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                          <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z" />
                        </svg>
                      </a>
                    </div>
                    <p className="text-gray-dark mt-2">@bvcaldeiraria</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-light p-8 rounded-lg shadow-md">
              <h2 className="text-2xl md:text-3xl font-bold mb-6 text-text">Envie uma Mensagem</h2>
              <ContactForm />
            </div>
          </div>
        </div>
