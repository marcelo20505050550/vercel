...
import { CheckCircle2, Phone, Play, Wrench, Gauge, Zap, Medal } from "lucide-react";
import BeforeAfterSlider from "../ui/BeforeAfterSlider";
import Image from "next/image";

export default function FerramentariaLandingPage() {
  const benefits = [
    {
      icon: Wrench,
      title: "Ferramentas Personalizadas",
      description: "Desenvolvimento de ferramentas específicas para suas necessidades"
    },
    {
      icon: Gauge,
      title: "Alta Precisão",
      description: "Tolerâncias rigorosas e acabamento perfeito em cada ferramenta"
    },
    {
      icon: Zap,
      title: "Produtividade Aumentada",
      description: "Ferramentas otimizadas para maximizar eficiência produtiva"
    },
    {
      icon: Medal,
      title: "Durabilidade Garantida",
      description: "Materiais de alta qualidade para longa vida útil"
    }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
                Ferramentaria
                <span className="block text-yellow-400 mt-2">de Precisão</span>
              </h1>

              <p className="text-xl leading-relaxed mb-8 max-w-xl" style={{ color: '#d4d4d4' }}>
                Fabricação de ferramentas especializadas, moldes e dispositivos de precisão para otimizar processos produtivos.
              </p>

              <div className="flex flex-col sm:flex-row gap-4">
                <motion.a
                  href="https://wa.me/5516991624446?text=Olá,%20gostaria%20de%20solicitar%20um%20orçamento%20para%20serviço%20de%20Ferramentaria"
                  target="_blank"
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-neutral-600 max-w-2xl mx-auto">
              Veja a qualidade das ferramentas que produzimos
            </p>
          </motion.div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
              Pronto para Suas Ferramentas Especializadas?
            </h2>
