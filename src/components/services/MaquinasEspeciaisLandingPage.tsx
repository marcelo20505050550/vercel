...
import { CheckCircle2, Phone, Play, Lightbulb, Cog, Rocket, Settings } from "lucide-react";
import BeforeAfterSlider from "../ui/BeforeAfterSlider";
import Image from "next/image";

export default function MaquinasEspeciaisLandingPage() {
  const benefits = [
    {
      icon: Lightbulb,
      title: "Inovação Constante",
      description: "Soluções criativas e inovadoras para desafios industriais complexos"
    },
    {
      icon: Cog,
      title: "Engenharia Avançada",
      description: "Projetos desenvolvidos com tecnologia de ponta e expertise técnica"
    },
    {
      icon: Rocket,
      title: "Eficiência Máxima",
      description: "Máquinas otimizadas para aumentar produtividade e reduzir custos"
    },
    {
      icon: Settings,
      title: "Suporte Completo",
      description: "Acompanhamento desde o projeto até a instalação e manutenção"
    }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl leading-relaxed mb-8 max-w-xl" style={{ color: '#d4d4d4' }}>
                Desenvolvimento de máquinas sob medida para processos industriais específicos, criando soluções exclusivas e inovadoras.
              </p>

              <div className="flex flex-col sm:flex-row gap-4">
                <motion.a
                  href="https://wa.me/5516991624446?text=Olá,%20gostaria%20de%20solicitar%20um%20orçamento%20para%20serviço%20de%20Máquinas%20Especiais"
                  target="_blank"
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-neutral-600 max-w-2xl mx-auto">
              Veja a transformação que nossas máquinas especiais proporcionam
            </p>
          </motion.div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
              Pronto para Sua Máquina Especial?
            </h2>
