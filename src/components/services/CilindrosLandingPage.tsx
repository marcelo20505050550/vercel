...
import { CheckCircle2, Phone, Play, CircleDot, Wrench, Zap, Award } from "lucide-react";
import BeforeAfterSlider from "../ui/BeforeAfterSlider";
import Image from "next/image";

export default function CilindrosLandingPage() {
  const benefits = [
    {
      icon: CircleDot,
      title: "Cilindros Personalizados",
      description: "Fabricação sob medida para atender especificações técnicas exatas"
    },
    {
      icon: Wrench,
      title: "Manutenção Especializada",
      description: "Serviços de reparo e manutenção preventiva e corretiva"
    },
    {
      icon: Zap,
      title: "Alta Performance",
      description: "Cilindros projetados para máxima eficiência e durabilidade"
    },
    {
      icon: Award,
      title: "Qualidade Garantida",
      description: "Testes rigorosos e certificação de qualidade em cada cilindro"
    }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
                ...
                <span className="block text-yellow-400 mt-2">e Pneumáticos</span>
              </h1>

              <p className="text-xl leading-relaxed mb-8 max-w-xl" style={{ color: '#d4d4d4' }}>
                Fabricação e manutenção de cilindros hidráulicos e pneumáticos sob medida para sistemas de automação industrial.
              </p>

              <div className="flex flex-col sm:flex-row gap-4">
                <motion.a
                  href="https://wa.me/5516991624446?text=Olá,%20gostaria%20de%20solicitar%20um%20orçamento%20para%20serviço%20de%20Cilindros"
                  target="_blank"
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-neutral-600 max-w-2xl mx-auto">
              Veja a qualidade dos cilindros que fabricamos e recuperamos
            </p>
          </motion.div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
              Precisa de Cilindros Hidráulicos ou Pneumáticos?
            </h2>
