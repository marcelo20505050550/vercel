...
import { CheckCircle2, Phone, Play, Zap, Users, Target, Trophy } from "lucide-react";
import BeforeAfterSlider from "../ui/BeforeAfterSlider";
import Image from "next/image";

export default function CaldeirariaLandingPage() {
  const benefits = [
    {
      icon: Zap,
      title: "Soluções Personalizadas",
      description: "Projetos sob medida para atender necessidades específicas da sua indústria"
    },
    {
      icon: Users,
      title: "Equipe Especializada",
      description: "Profissionais qualificados com anos de experiência em caldeiraria"
    },
    {
      icon: Target,
      title: "Precisão Garantida",
      description: "Equipamentos modernos para garantir exatidão em cada projeto"
    },
    {
      icon: Trophy,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl leading-relaxed mb-8 max-w-xl" style={{ color: '#d4d4d4' }}>
                Soluções sob medida para estruturas e equipamentos metálicos com alta precisão, qualidade e acabamento profissional.
              </p>

              <div className="flex flex-col sm:flex-row gap-4">
                <motion.a
                  href="https://wa.me/5516991624446?text=Olá,%20gostaria%20de%20solicitar%20um%20orçamento%20para%20serviço%20de%20Caldeiraria"
                  target="_blank"
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-neutral-600 max-w-2xl mx-auto">
              Veja a transformação que nosso serviço de caldeiraria proporciona
            </p>
          </motion.div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
              Pronto para Seu Projeto de Caldeiraria?
            </h2>
